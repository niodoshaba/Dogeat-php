...
window.addEventListener('load',function(){
    ...
    //點擊圖標加入購物車
    $(".atc").click(function () { 
        let pro_num = $(this).attr("data-atcnum");
        AddToCartDatabase(pro_num);
    });
    //加入購物車資料庫
    function AddToCartDatabase(pro_num){
        $.ajax({
            url: "/front/index.php?action=CartAdd&controller=CartControllers",   //後端的URL
            type: "GET",
            dataType: "text",
            cache: false,
            data: {"pro_no":pro_num},
